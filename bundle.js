...
window.addEventListener('DOMContentLoaded', () => {
  const resizableSwiper = (breakpoint, swiperClass, swiperSettings) => {
    ...
    const enableSwiper = function (className, settings) {
      swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](className, settings);
    };
  ...
  resizableSwiper('(max-width: 767px)', '.swiper.slider-1', {
    loop: true,
    spaceBetween: -50,
    slidesPerView: 'auto',
    freeMode: true,
...
window.addEventListener('DOMContentLoaded', () => {
  const resizableSwiper2 = (breakpoint, swiperClass, swiperSettings) => {
    ...
    breakpoint = window.matchMedia(breakpoint);
    const enableSwiper = function (className, settings) {
      swiper2 = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](className, settings);
    };
    const checker = function () {
      if (breakpoint.matches) {
        return enableSwiper(swiperClass, swiperSettings);
  ...
  resizableSwiper2('(max-width: 767px)', '.swiper.slider-2', {
    loop: true,
    spaceBetween: -50,
    slidesPerView: 'auto',
    freeMode: true,
...
window.addEventListener('DOMContentLoaded', () => {
  const resizableSwiper3 = (breakpoint, swiperClass, swiperSettings) => {
    ...
    breakpoint = window.matchMedia(breakpoint);
    const enableSwiper = function (className, settings) {
      swiper3 = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](className, settings);
    };
    const checker = function () {
      if (breakpoint.matches) {
        return enableSwiper(swiperClass, swiperSettings);
  ...
  resizableSwiper3('(max-width: 767px)', '.swiper.slider-3', {
    loop: true,
    spaceBetween: -50,
    slidesPerView: 'auto',
    freeMode: true,
